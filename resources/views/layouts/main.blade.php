    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top fixed-navbar">
        ...
        <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle  bg-transparent border-dark" type="button"
                ...
                <!-- Tulisan "Selamat datang" di atas nama pengguna -->
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                ...
                <!-- Menu Logout -->
                <li><a class="dropdown-item" href="#" style="background-color: transparent;">Logout</a></li>
            </ul>
        </div>


    </nav>
    <div style="background-color: #387e7c; height: 300px;"></div>
    @yield('content')
